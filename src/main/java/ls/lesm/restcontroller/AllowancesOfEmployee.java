...
public class AllowancesOfEmployee {
	...
	@GetMapping("/SubmitTheAllowances/{shiftAllowances}/{specialAllowances}/{joiningBonus}/{joiningBonusTenure}/{EmployeeId}")
	public ResponseEntity<?> enterAllowances(@PathVariable Double shiftAllowances,
			@PathVariable Double specialAllowances, @PathVariable Double joiningBonus,
			@PathVariable Integer joiningBonusTenure, @PathVariable String EmployeeId) {
